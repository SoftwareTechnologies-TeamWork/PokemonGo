...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../Pages CSS/PokedexStyle.css">
    ...
    <div id="wrapper_inner">
        ...
        <div id="menu">
            ...
            <ul>
                ...
                <li><a href="Pokedex.php" class="current">Pokedex</a></li>
        ...
        function drawData($orderedData, $headers, $name, $number) {
            ...
            echo "<div id='wrapper'>";
                ...
                echo "<div id='portrait'>";
                    ...
                    echo "<img src='http://assets.pokemon.com/assets/cms2/img/pokedex/detail/" . $number . ".png'/>";
