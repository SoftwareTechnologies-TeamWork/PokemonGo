    ...
    <div class="quiz">
        ...
        if (!isset($_SESSION['score'])) {
            ...
            <div class=\"quiz_header\">
                <h2>Can you name all these pokemons?</h2>
            </div>
            ...
            <div id = 'question_body'>
                <form id='quiz_form'>
                    ...
                    <input type='submit' value='Next' id='next_button'/>
                </form>
                
                <input type='text' id='score' value='" . $_SESSION['score'] . "' style='display:none;'/>
                <input type='text' id='currentQuestion' value='" . $_SESSION['currentQuestion'] . "' style='display:none;'/>
            </div>
            ";
        }
        ?>
